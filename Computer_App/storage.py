...
def createUser():
    ...
    confirm = raw_input("Please confirm your password\n")
...
def enterPass(user):
    use = raw_input("What would you like to use the following password for?\n")
    password = raw_input("Enter the password to be stored\n")
